...
\xdef\fmtversion{\fmtversion+PWEBMAC5.2}
...
\def\\#1{\leavevmode\hbox{\it
  \ifacrohint\def\_{\hbox{\tt\char`\_}}\fi % searchable underline in PDF/HINT
...
\def\&#1{\leavevmode\hbox{\bf
  \ifacrohint\def\_{\hbox{\tt\char`\_}}\else % searchable underline in PDF/HINT
