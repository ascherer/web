...
@y
\.{pdftex0.c: In function 'doextension':}\hfil\break
\.{\quad pdftex0.c:37849:40: warning: overflow in conversion from 'long int' to 'short int'}\hfil\break
\.{\qquad changes value from '-268435455' to '1' [-Woverflow]}\hfil\break
\.{\quad mem [curlist .tailfield + 1 ].hh.b0 = -268435455L ;}
@z
