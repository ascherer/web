...
REPEAT IF VAL>=214748364 THEN BEGIN WRITELN(TERMOUT);
WRITE(TERMOUT,'! Constant too big');ERROR;
...
REPEAT IF VAL>=268435456 THEN BEGIN WRITELN(TERMOUT);
WRITE(TERMOUT,'! Constant too big');ERROR;
...
IF VAL>=134217728 THEN BEGIN WRITELN(TERMOUT);
WRITE(TERMOUT,'! Constant too big');ERROR;
...
TERMOUT);WRITE(TERMOUT,'! Definition flushed, must start with ',
